  ...
  return (
    <div className="container-base py-14 space-y-14">
      ...
      <div>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          ...
          <div className="space-y-6 text-stone-700">
            {/* Historia */}
            <div>
              <h2 className="mb-1 text-xl font-semibold text-bosque">Historia de la finca</h2>
            ...
            {/* Ubicación */}
            <div>
              <h2 className="mb-1 text-xl font-semibold text-bosque">Ubicación y entorno natural</h2>
              <p className="leading-relaxed">
      ...
      <div className="rounded-2xl bg-crema px-8 py-10 shadow-soft">
        <h2 className="mb-2 text-2xl font-bold text-bosque">Qué incluye el alquiler</h2>
      ...
      {/* Amenidades */}
      <div>
        <h2 className="mb-6 text-2xl font-bold text-bosque">Amenidades principales</h2>
